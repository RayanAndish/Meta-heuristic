...
with open('BWOA-Griewank-D30-25000.csv', mode='w') as results_file:
    ...
    for initialization in range(num_initializations):
        ...
        bwoa = BWOA(griewank, dim=30, num_agents=20, iterations=25000, alpha=0.1, beta=0.1, bounds=[(-600, 600)])
