...
with open('AFHA-Rosenbrock-D30-10000.csv', mode='w') as results_file:
    ...
    dim = 30
    start_time = time.time()
    best_fish, best_fitness, all_solutions, all_fitness, execution_time = archer_fish_hunter(func=rosenbrock, n=50,
                                                                                             dim=30, max_iter=10000,
                                                                                             bounds=[(-5, 10)] * dim)
