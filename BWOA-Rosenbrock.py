...
with open('BWOA-Rosenbrock-D30-25000.csv', mode='w') as results_file:
    ...
    for initialization in range(num_initializations):
        ...
        bwoa = BWOA(rosenbrock, dim=30, num_agents=20, iterations=25000, alpha=0.1, beta=0.1, bounds=[(-5, 10)])
        ...
        print(f"Griewank function - Execution time: {end_time - start_time} seconds")
