...
with open('BESOA-Rosenbrock-D30-25000.csv', mode='w') as results_file:
    ...
    for t in range(max_iter):
        ...
        lb_rosen = (-5)
        ub_rosen = (10)
        Xbest, Gbest, CNVG = BESOA(func=rosenbrock, lb=lb_rosen, ub=ub_rosen, dim=dim, N=N, max_iter=t+1, pa=pa, pb=pb, pc=pc, ps=ps, pm=pm, pe=pe)
        end_time = time.time()
