...
def employed_bee_phase(employed_bees, search_space):
...
def update_population(employed_bees, onlooker_bees, search_space, func):
    ...
    new_employed_bees = employed_bee_phase(employed_bees, search_space)
    ...
    new_onlooker_bees = employed_bee_phase(selected_onlooker_bees, search_space)
...
with open('HBM-Sphere-D10-25000.csv', mode='w') as results_file:
    ...
    result = hbm_algorithm(func=sphere, bees=50, dim=10, search_space=(-5, 12), iterations=25000)
