...
with open('HBM-Michalewicz-D30-25000.csv', mode='w') as results_file:
    ...
    result = hbm_algorithm(func=michalewicz, bees=50, dim=30, search_space=(0, np.pi), iterations=25000)
