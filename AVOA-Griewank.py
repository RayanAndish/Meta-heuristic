...
with open('AVOA-Greinwank-D30-25000.csv', mode='w') as results_file:
    results_writer = csv.writer(results_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    results_writer.writerow(['Iteration', 'Best_Solutions', 'Best_Fitness', 'Execution_Time'])

    lb_gr = [-600] * dim
    ub_gr = [600] * dim
    all_solutions, all_fitness, execution_time = AVA(griewank, lb=lb_gr, ub=ub_gr, n_vultures=10, n_iterations=25000)
