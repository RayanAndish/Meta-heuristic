...
with open('AFHA-Michalewicz-D30-25000.csv', mode='w') as results_file:
    results_writer = csv.writer(results_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    results_writer.writerow(['Iteration', 'Best_Solutions', 'Best_Fitness', 'Execution_Time'])

    dim=30
    Mbounds = [(0, np.pi)] * dim
    best_fish, best_fitness, all_solutions, all_fitness, execution_time = archer_fish_hunter(func=michalewicz, n=50, dim=30, max_iter=25000, bounds=Mbounds)
