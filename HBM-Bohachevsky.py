...
def initialize_population(bees, dim, search_space):
    random_numbers = np.random.uniform(search_space[0], search_space[1], size=(bees, dim))
...
def hbm_algorithm(func, bees, dim, search_space, iterations):
    ...
    for iteration in range(iterations):
        ...
        employed_bees, employed_fitness = select_best_n(population, fitness, bees)
...
with open('HBM-Bohachevsky-D4-25000.csv', mode='w') as results_file:
    ...
    result = hbm_algorithm(func=bohachevsky, bees=50, dim=4, search_space=(-100, 100), iterations=25000)
