...
# Define the dimension for the Bohachevsky function
Bohadim = 4

# Save results in a CSV file
with open('AVOA-Boha-D4-25000.csv', mode='w') as results_file:
    ...
    lb_boha = [-100, -100] * Bohadim
    ub_boha = [100, 100] * Bohadim
    all_solutions, all_fitness, execution_time = AVA(bohachevsky, lb=lb_boha, ub=ub_boha, n_vultures=10,
                                                     n_iterations=25000)
