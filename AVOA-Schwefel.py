...
with open('AVOA-Schwefel-D30-25000.csv', mode='w') as results_file:
    results_writer = csv.writer(results_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    results_writer.writerow(['Iteration', 'Best_Solutions', 'Best_Fitness', 'Execution_Time'])

    lb_sch = [-500] * dim
    ub_sch = [500] * dim
    all_solutions, all_fitness, execution_time = AVA(schwefel, lb=lb_sch, ub=ub_sch, n_vultures=10, n_iterations=25000)
