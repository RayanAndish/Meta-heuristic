...
with open('AFHA-Schwefel-D30-25000.csv', mode='w') as results_file:
    results_writer = csv.writer(results_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    results_writer.writerow(['Iteration', 'Best_Solutions', 'Best_Fitness', 'Execution_Time'])

    dim=30
    best_fish, best_fitness, all_solutions, all_fitness, execution_time = archer_fish_hunter(func=schwefel, n=50, dim=30, max_iter=25000, bounds=[(-500,500)] * dim)
