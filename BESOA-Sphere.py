...
with open('BESOA-Sphere-D30-25000.csv', mode='w') as results_file:
    ...
    for t in range(max_iter):
        ...
        lb_sph = (-5)
        ub_sph = (12)
        Xbest, Gbest, CNVG = BESOA(func=sphere, lb=lb_sph, ub=ub_sph, dim=dim, N=N, max_iter=t+1, pa=pa, pb=pb, pc=pc,  ps=ps, pm=pm, pe=pe)
        end_time = time.time()
