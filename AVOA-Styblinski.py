...
with open('AVOA-Styblinski-D30-25000.csv', mode='w') as results_file:
    results_writer = csv.writer(results_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    results_writer.writerow(['Iteration', 'Best_Solutions', 'Best_Fitness', 'Execution_Time'])

    lb_sty = [-5] * dim
    ub_sty = [5] * dim
    all_solutions, all_fitness, execution_time = AVA(styblinski_tang, lb=lb_sty, ub=ub_sty, n_vultures=10, n_iterations=25000)
