...
with open('BWOA-Bohachevski-D4-25000.csv', mode='w') as results_file:
    ...
    for initialization in range(num_initializations):
        ...
        BObounds = [(-100, 100)] * 4
        bwoa = BWOA(bohachevsky, dim=4, num_agents=20, iterations=25000, alpha=0.1, beta=0.1, bounds=BObounds)
