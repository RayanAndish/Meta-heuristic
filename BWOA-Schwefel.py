...
with open('BWOA-Schwefel-D30-25000.csv', mode='w') as results_file:
    ...
    for initialization in range(num_initializations):
        ...
        bwoa = BWOA(schwefel, dim=30, num_agents=20, iterations=25000, alpha=0.1, beta=0.1, bounds=[(-500, 500)])
