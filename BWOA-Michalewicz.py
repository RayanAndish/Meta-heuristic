...
with open('BWOA-Michalewicz-D30-25000.csv', mode='w') as results_file:
    ...
    for initialization in range(num_initializations):
        ...
        Mbounds = [(0, np.pi)]
        bwoa = BWOA(michalewicz, dim=30, num_agents=20, iterations=25000, alpha=0.1, beta=0.1, bounds=Mbounds)
        ...
        for iteration, (fitness_values, agents) in enumerate(zip(all_fitness, all_agents)):
            ...
            print(f"teration {iteration + 1} - Best fitness: {best_fitness}")
