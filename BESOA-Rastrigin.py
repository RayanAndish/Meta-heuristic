...
with open('BESOA-Rastrigin-D30-25000.csv', mode='w') as results_file:
    ...
    for t in range(max_iter):
        ...
        lb_rast = (-5)
        ub_rast = (12)
        Xbest, Gbest, CNVG = BESOA(func=rastrigin, lb=lb_rast, ub=ub_rast, dim=dim, N=N, max_iter=t+1, pa=pa, pb=pb, pc=pc, ps=ps, pm=pm, pe=pe)
        end_time = time.time()
